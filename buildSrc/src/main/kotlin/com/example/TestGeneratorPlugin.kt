...
class TestGeneratorPlugin : Plugin<Project> {
    ...
    override fun apply(project: Project) {
        ...
        val generateSchemeTask = project.tasks.register(
            ...
            tlSourcesDir = File(project.rootDir, "Ansible/src/main/java/org/telegram/tgnet")
            tlSourcesDirectDir = File(project.rootDir, "Ansible_AppStandalone/src/main/java/org/telegram/tgnet")
