...
import org.ansible.messenger.utils.ImmutableByteArrayOutputStream;
...
//        FileLog.e("FileLoadOperation " + getFileName() + " setStream(" + stream + ")");
    ...
    public FileLoadOperation(TLRPC.Document documentLocation, Object parent) {
        ...
        try {
            ...
            ungzip = "application/x-ansible-sticker".equals(documentLocation.mime_type) || "application/x-tgwallpattern".equals(documentLocation.mime_type);
