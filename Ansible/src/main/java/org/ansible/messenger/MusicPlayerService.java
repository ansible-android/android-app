...
public class MusicPlayerService extends Service implements NotificationCenter.NotificationCenterDelegate {
    ...
    public static final String NOTIFY_PREVIOUS = "org.ansible.android.musicplayer.previous";
    public static final String NOTIFY_CLOSE = "org.ansible.android.musicplayer.close";
    public static final String NOTIFY_PAUSE = "org.ansible.android.musicplayer.pause";
    public static final String NOTIFY_PLAY = "org.ansible.android.musicplayer.play";
    public static final String NOTIFY_NEXT = "org.ansible.android.musicplayer.next";
    public static final String NOTIFY_SEEK = "org.ansible.android.musicplayer.seek";
    public static final String NOTIFY_REPEAT = "org.ansible.android.musicplayer.repeat";
    public static final String NOTIFY_SHUFFLE = "org.ansible.android.musicplayer.shuffle";
    ...
    private void createNotification(MessageObject messageObject, boolean forBitmap) {
        ...
        if (messageObject.isMusic()) {
            ...
            if (fromId != 0) {
                if (owner.peer_id instanceof TLRPC.TL_peerUser) {
                    intent.setData(Uri.parse("as://openmessage?user_id=" + fromId + "&message_id=" + messageObject.getId()));
                } else {
                    intent.setData(Uri.parse("as://openmessage?chat_id=" + fromId + "&message_id=" + messageObject.getId()));
                }
            }
        }
