...
import org.ansible.ui.Components.ReplyMessageLine;
import org.ansible.ui.Components.TornEdge;
...
import org.ansible.ui.Components.SquigglyLinesSpan;
...
public class RichMessageLayout {
    ...
    private org.ansible.ui.Components.Text showMoreText;
...
//                }
    ...
    private void drawShowMoreButton(Canvas canvas, int contentBottom) {
        ...
        if (showMoreText == null) {
            showMoreText = new org.ansible.ui.Components.Text(LocaleController.getString(R.string.ShowMore), 16, AndroidUtilities.bold());
        }
