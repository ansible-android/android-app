...
import static org.ansible.messenger.AndroidUtilities.rectTmp;
...
import org.ansible.ui.Stories.LiveCommentsView;
...
//        toptopLayout.addView(balanceView, LayoutHelper.createLinear(LayoutHelper.WRAP_CONTENT, LayoutHelper.WRAP_CONTENT, 0, Gravity.TOP | Gravity.RIGHT, 6, 0, 6, 0));
        ...
        statusView.setText(Emoji.replaceEmoji(AndroidUtilities.replaceTags(me != null ? LocaleController.formatPluralStringComma("DiamondsReactionTextSent", me.count) : formatString(R.string.DiamondsReactionText, chat == null ? "" : chat.title)), statusView.getPaint().getFontMetricsInt(), false));
        if (sendEnabled && !liveStories) {
