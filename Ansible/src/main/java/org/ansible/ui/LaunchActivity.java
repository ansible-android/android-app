...
import static org.ansible.ui.Components.Premium.LimitReachedBottomSheet.TYPE_BOOSTS_FOR_USERS;
...
import org.ansible.messenger.AutoDeleteMediaTask;
import org.ansible.messenger.BackupAgent;
import org.ansible.messenger.BetaUpdate;
import org.ansible.messenger.BirthdayController;
import org.ansible.messenger.BotGuardHelper;
import org.ansible.messenger.BotWebViewVibrationEffect;
import org.ansible.messenger.BuildConfig;
import org.ansible.messenger.BuildVars;
import org.ansible.messenger.ChannelBoostsController;
import org.ansible.messenger.ChatObject;
import org.ansible.messenger.ContactsController;
import org.ansible.messenger.ContactsLoadingObserver;
import org.ansible.messenger.DialogObject;
import org.ansible.messenger.FileLoader;
import org.ansible.messenger.FileLog;
import org.ansible.messenger.FingerprintController;
import org.ansible.messenger.FlagSecureReason;
import org.ansible.messenger.GenericProvider;
...
import org.ansible.messenger.OpenAttachedMenuBotReceiver;
import org.ansible.messenger.PushListenerController;
import org.ansible.messenger.R;
import org.ansible.messenger.SendMessagesHelper;
import org.ansible.messenger.SharedConfig;
import org.ansible.messenger.SharedPrefsHelper;
import org.ansible.messenger.TopicsController;
...
import org.ansible.messenger.pip.activity.IPipActivity;
import org.ansible.messenger.pip.activity.IPipActivityHandler;
import org.ansible.messenger.pip.activity.IPipActivityListener;
import org.ansible.messenger.utils.FrameMetricsOverlayView;
import org.ansible.messenger.utils.LeakDetector;
import org.ansible.messenger.utils.WindowVisibilityManager;
import org.ansible.messenger.video.VideoAds;
import org.ansible.messenger.voip.VideoCapturerDevice;
import org.ansible.messenger.voip.VoIPGroupNotification;
import org.ansible.messenger.voip.VoIPPendingCall;
import org.ansible.messenger.voip.VoIPPreNotificationService;
...
import org.ansible.ui.ActionBar.BottomSheetTabsOverlay;
import org.ansible.ui.ActionBar.DrawerLayoutContainer;
import org.ansible.ui.ActionBar.INavigationLayout;
import org.ansible.ui.ActionBar.Theme;
import org.ansible.ui.Cells.ChatMessageCell;
import org.ansible.ui.Cells.LanguageCell;
import org.ansible.ui.Components.ActivityWindowEmptyBackgroundDrawable;
import org.ansible.ui.Components.AlertsCreator;
import org.ansible.ui.Components.AppIconBulletinLayout;
import org.ansible.ui.Components.AttachBotIntroTopView;
import org.ansible.ui.Components.AudioPlayerAlert;
import org.ansible.ui.Components.BatteryDrawable;
import org.ansible.ui.Components.BlockingUpdateView;
...
import org.ansible.ui.Components.Easings;
import org.ansible.ui.Components.EmbedBottomSheet;
...
import org.ansible.ui.Components.GroupCallPip;
import org.ansible.ui.Components.JoinGroupAlert;
import org.ansible.ui.Components.LayoutHelper;
import org.ansible.ui.Components.PasscodeView;
import org.ansible.ui.Components.PasscodeViewDialog;
import org.ansible.ui.Components.PhonebookShareAlert;
import org.ansible.ui.Components.PipRoundVideoView;
import org.ansible.ui.Components.PipVideoOverlay;
import org.ansible.ui.Components.Premium.LimitReachedBottomSheet;
import org.ansible.ui.Components.Premium.boosts.BoostPagerBottomSheet;
import org.ansible.ui.Components.Premium.boosts.GiftInfoBottomSheet;
...
import org.ansible.ui.Components.SearchTagsList;
import org.ansible.ui.Components.ShareTopView;
import org.ansible.ui.Components.SharingLocationsAlert;
import org.ansible.ui.Components.SizeNotifierFrameLayout;
import org.ansible.ui.Components.StickerSetBulletinLayout;
import org.ansible.ui.Components.StickersAlert;
import org.ansible.ui.Components.TermsOfServiceView;
import org.ansible.ui.Components.TextStyleSpan;
import org.ansible.ui.Components.ThemeEditorView;
import org.ansible.ui.Components.UndoView;
import org.ansible.ui.Components.inset.WindowAnimatedInsetsProvider;
...
//            dismissAllWeb();
        ...
        if ((flags & Intent.FLAG_ACTIVITY_LAUNCHED_FROM_HISTORY) == 0) {
            if (intent != null && intent.getAction() != null && !restore) {
                ...
                } else if ("org.ansible.messenger.CREATE_STICKER_PACK".equals(intent.getAction())) {
                    try {
...
//                                                storyId = Utilities.parseInt(data.getQueryParameter("story"));
                                ...
                                try (Cursor cursor = getContentResolver().query(intent.getData(), null, null, null, null)) {
                                    if (cursor != null) {
                                        if (cursor.moveToFirst()) {
                                            ...
                                            if (TextUtils.equals(mimeType, "vnd.android.cursor.item/vnd.org.ansible.messenger.android.call")) {
                                                audioCallUser = true;
                                            } else if (TextUtils.equals(mimeType, "vnd.android.cursor.item/vnd.org.ansible.messenger.android.call.video")) {
                                                videoCallUser = true;
                                            }
                                        }
                                    }
                ...
                } else if (intent.getAction().equals("org.ansible.messenger.OPEN_ACCOUNT")) {
                    open_settings = 1;
                                ...
                                StarsController.getInstance(currentAccount).subscribeTo(group, invite, (status, dialogId) -> {
                                    if ("paid".equals(status) && dialogId != 0) {
                                        AndroidUtilities.runOnUIThread(() -> {
                                            ...
                                            if (chat != null) {
                                                AndroidUtilities.runOnUIThread(() -> {
                                                    BulletinFactory.of(chatActivity).createSimpleBulletin(R.raw.stars_send, LocaleController.getString(R.string.DiamondsSubscriptionCompleted), AndroidUtilities.replaceTags(formatPluralString("DiamondsSubscriptionCompletedText", (int) stars, chat.title))).show(true);
                                                }, 250);
                                            }
                                        });
                                    }
