...
import org.ansible.messenger.AnsibleQRCodeWriter;
...
import org.ansible.tgnet.ResultCallback;
...
import org.ansible.ui.Components.ChatThemeBottomSheet;
...
import org.ansible.ui.Components.ThemeSmallPreviewView;
    ...
    private static class QrView extends View {
        ...
        private void drawLoading(Canvas canvas) {
            if (loadingMatrix != null) {
                ...
                AnsibleQRCodeWriter.drawSideQuads(canvas, padding, top, bitmapGradientPaint, 7, multiple, 16, size, .75f, radii, true);
        ...
        private void prepareContent(int w, int h) {
            ...
            AnsibleQRCodeWriter writer = new AnsibleQRCodeWriter();
            int version;
