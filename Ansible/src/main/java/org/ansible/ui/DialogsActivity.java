...
import static org.ansible.ui.Components.AlertsCreator.createClearOrDeleteDialogsAlert;
...
import org.ansible.messenger.AnimationNotificationsLocker;
import org.ansible.messenger.ApplicationLoader;
import org.ansible.messenger.BirthdayController;
import org.ansible.messenger.BotWebViewVibrationEffect;
...
import org.ansible.messenger.FilesMigrationService;
...
import org.ansible.messenger.XiaomiUtilities;
...
import org.ansible.messenger.utils.SearchTextWatcher;
...
import org.ansible.ui.ActionBar.MenuDrawable;
import org.ansible.ui.ActionBar.SimpleTextView;
import org.ansible.ui.ActionBar.Theme;
import org.ansible.ui.ActionBar.ThemeDescription;
import org.ansible.ui.Adapters.DialogsAdapter;
import org.ansible.ui.Adapters.DialogsSearchAdapter;
import org.ansible.ui.Adapters.FiltersView;
import org.ansible.ui.Cells.ActiveGiftAuctionsHintCell;
import org.ansible.ui.Cells.AnimatedStatusView;
import org.ansible.ui.Cells.ArchiveHintInnerCell;
import org.ansible.ui.Cells.DialogCell;
import org.ansible.ui.Cells.DialogsEmptyCell;
import org.ansible.ui.Cells.DialogsHintCell;
import org.ansible.ui.Cells.GraySectionCell;
import org.ansible.ui.Cells.HashtagSearchCell;
import org.ansible.ui.Cells.HeaderCell;
import org.ansible.ui.Cells.HintDialogCell;
import org.ansible.ui.Cells.LoadingCell;
import org.ansible.ui.Cells.ProfileSearchCell;
import org.ansible.ui.Cells.RequestPeerRequirementsCell;
...
import org.ansible.ui.Cells.UnconfirmedAuthHintCell;
...
import org.ansible.ui.Components.ArchiveHelp;
import org.ansible.ui.Components.AvatarDrawable;
import org.ansible.ui.Components.BackupImageView;
import org.ansible.ui.Components.BlurredRecyclerView;
import org.ansible.ui.Components.ColoredImageSpan;
import org.ansible.ui.Components.DialogsActivityStatusLayout;
import org.ansible.ui.Components.DialogsActivityTopBubblesFadeView;
import org.ansible.ui.Components.DialogsActivityTopPanelLayout;
import org.ansible.ui.Components.FragmentFloatingButton;
import org.ansible.ui.Components.FragmentSearchField;
import org.ansible.ui.Components.IconBackgroundColors;
...
import org.ansible.ui.Components.blur3.BlurredBackgroundWithFadeDrawable;
import org.ansible.ui.Components.blur3.DownscaleScrollableNoiseSuppressor;
import org.ansible.ui.Components.blur3.RenderNodeWithHash;
...
import org.ansible.ui.Components.blur3.source.BlurredBackgroundSource;
...
import org.ansible.ui.Components.chat.ChatInputViewsContainer;
...
import org.ansible.ui.Components.ChatActivityEnterView;
...
import org.ansible.ui.Components.DialogsItemAnimator;
import org.ansible.ui.Components.FilterTabsView;
import org.ansible.ui.Components.FiltersListBottomSheet;
...
import org.ansible.ui.Components.FloatingDebug.FloatingDebugProvider;
import org.ansible.ui.Components.FolderBottomSheet;
import org.ansible.ui.Components.FolderDrawable;
import org.ansible.ui.Components.ForegroundColorSpanThemable;
import org.ansible.ui.Components.Forum.ForumUtilities;
import org.ansible.ui.Components.FragmentContextView;
...
import org.ansible.ui.Components.NumberTextView;
import org.ansible.ui.Components.PacmanAnimation;
...
import org.ansible.ui.Components.PullForegroundDrawable;
import org.ansible.ui.Components.RLottieDrawable;
import org.ansible.ui.Components.Reactions.ReactionsLayoutInBubble;
import org.ansible.ui.Components.RecyclerAnimationScrollHelper;
import org.ansible.ui.Components.RecyclerItemsEnterAnimator;
import org.ansible.ui.Components.RecyclerListView;
import org.ansible.ui.Components.SearchViewPager;
import org.ansible.ui.Components.ShareTopView;
...
import org.ansible.ui.Components.StickersAlert;
...
import org.ansible.ui.Stories.DialogStoriesCell;
...
import org.ansible.ui.community.CommunityChatType;
import org.ansible.ui.community.CommunityEditActivity;
import org.ansible.ui.community.CommunityPendingRequestsActivity;
import org.ansible.ui.community.CommunityUtils;
import org.ansible.ui.community.cells.CommunityRequestsCell;
...
//            }
    ...
    public View createView(final Context context) {
        ...
        if (onlySelect) {
            ...
            if (folderId != 0) {
                ...
                logoDrawable = context.getResources().getDrawable(R.drawable.ansible_logo_2).mutate();
    ...
    private void updateDialogsHint() {
        ...
        if (isInPreviewMode()) {
            ...
            dialogsHintCell.setText(StarsIntroActivity.replaceStarsWithPlain(formatPluralStringComma("StarsSubscriptionExpiredHintTitle2", (int) (starsNeeded - c.balance.amount <= 0 ? starsNeeded : starsNeeded - c.balance.amount), starsNeededName), .72f), LocaleController.getString(R.string.DiamondsSubscriptionExpiredHintText));
            dialogsHintCell.setOnCloseListener(v -> {
