...
import org.ansible.ui.Cells.TextDetailSettingsCell;
import org.ansible.ui.Cells.TextInfoPrivacyCell;
import org.ansible.ui.Cells.TextSettingsCell;
...
import org.ansible.ui.Components.EmptyTextProgressView;
import org.ansible.ui.Components.HintEditText;
...
import org.ansible.ui.Components.SlideView;
...
public class PassportActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    private void createPasswordInterface(Context context) {
        ...
        actionBar.setTitle(LocaleController.getString(R.string.AnsiblePassport));
        ...
        noPasswordTextView.setText(LocaleController.getString(R.string.AnsiblePassportCreatePasswordInfo));
        ...
        noPasswordSetTextView.setText(LocaleController.getString(R.string.AnsiblePassportCreatePassword));
        ...
        passwordForgotButton.setOnClickListener(v -> {
            if (currentPassword.has_recovery) {
                ...
                builder.setNegativeButton(LocaleController.getString(R.string.RestorePasswordResetAccount), (dialog, which) -> Browser.openUrl(getParentActivity(), "https://ansible.su/deactivate?phone=" + UserConfig.getInstance(currentAccount).getClientPhone()));
    ...
    private void createManageInterface(Context context) {
        ...
        deletePassportCell.setText(LocaleController.getString(R.string.AnsiblePassportDelete), false);
        ...
        deletePassportCell.setOnClickListener(v -> {
            AlertDialog.Builder builder = new AlertDialog.Builder(getParentActivity());
            builder.setTitle(LocaleController.getString(R.string.AnsiblePassportDeleteTitle));
            builder.setMessage(LocaleController.getString(R.string.AnsiblePassportDeleteAlert));
    ...
    private void createIdentityInterface(final Context context) {
        ...
        if (currentDocumentsType != null) {
            ...
            scanDocumentCell.setOnClickListener(v -> {
                ...
                CameraScanActivity fragment = new CameraScanActivity(org.ansible.ui.CameraScanActivity.TYPE_MRZ);
