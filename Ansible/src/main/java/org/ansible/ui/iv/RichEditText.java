...
public class RichEditText extends EditTextCaption {
    ...
    private int currentAccount = org.ansible.messenger.UserConfig.selectedAccount;
    ...
    public void addStyle(int flag, int start, int end) {
        ...
        if ((flag & org.ansible.ui.Components.TextStyleSpan.FLAG_STYLE_SPOILER) != 0) invalidateSpoilers();
        notifySpansChanged();
    }
