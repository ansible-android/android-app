...
public class RichButtonRowCell extends RichBlockCell implements Theme.Colorable {
    ...
    public RichButtonRowCell(Context context, int currentAccount, Theme.ResourcesProvider resourcesProvider) {
        ...
        addButton.setContentDescription(org.ansible.messenger.LocaleController.getString(R.string.Add));
        ...
        emptyAddButton.setText(org.ansible.messenger.LocaleController.getString(R.string.RichEditorAddButton));
