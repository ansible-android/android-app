...
import org.ansible.messenger.ChatMessageSharedResources;
...
import org.ansible.messenger.MessagePreviewParams;
...
import org.ansible.ui.Cells.IMessageCell;
    ...
    private class Page extends FrameLayout {
        ...
        public Page(Context context, int tab) {
            ...
            if (textSelectionOverlay != null) {
                ...
                addView(textSelectionOverlay, LayoutHelper.createFrame(LayoutHelper.MATCH_PARENT, LayoutHelper.MATCH_PARENT, Gravity.TOP | Gravity.LEFT, 0, org.ansible.ui.ActionBar.ActionBar.getCurrentActionBarHeight() / AndroidUtilities.density, 0, 0));
            }
        ...
        protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
            ...
            ((MarginLayoutParams) chatListView.getLayoutParams()).topMargin = org.ansible.ui.ActionBar.ActionBar.getCurrentActionBarHeight();
            if (isLandscapeMode) {
