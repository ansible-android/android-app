package org.ansible.ui.Components.Premium;
...
public class PremiumPreviewBottomSheet extends BottomSheetWithRecyclerListView implements NotificationCenter.NotificationCenterDelegate {
    ...
    public void setTitle(boolean animated) {
        ...
        if (emojiStatusCollectible != null) {
            ...
            titleView[0].setText(AndroidUtilities.replaceSingleTag(LocaleController.formatString(R.string.AnsiblePremiumUserStatusCollectibleDialogTitle, DialogObject.getShortName(user), collectionName), () -> {
            ...
            subtitleView.setText(AndroidUtilities.replaceTags(LocaleController.getString(R.string.AnsiblePremiumUserStatusDialogSubtitle)));
        } else if (statusStickerSet != null) {
            final String stickerSetPlaceholder = "<STICKERSET>";
            String string = LocaleController.formatString(R.string.AnsiblePremiumUserStatusDialogTitle, ContactsController.formatName(user.first_name, user.last_name), stickerSetPlaceholder);
            ...
            titleView[0].setText(AndroidUtilities.replaceTags(LocaleController.formatString(R.string.AnsiblePremiumUserStatusDefaultDialogTitle, ContactsController.formatName(user.first_name, user.last_name))));
            subtitleView.setText(AndroidUtilities.replaceTags(LocaleController.formatString(R.string.AnsiblePremiumUserStatusDialogSubtitle, ContactsController.formatName(user.first_name, user.last_name))));
        } else if (giftTier != null) {
            if (isOutboundGift) {
                titleView[0].setText(AndroidUtilities.replaceSingleLink(LocaleController.formatString(R.string.AnsiblePremiumUserGiftedPremiumOutboundDialogTitleWithPlural, user != null ? user.first_name : "", LocaleController.formatPluralString("GiftMonths", giftTier.getMonths())), accentColor == null ? getThemedColor(Theme.key_windowBackgroundWhiteBlueButton) : accentColor));
                subtitleView.setText(AndroidUtilities.replaceSingleLink(LocaleController.formatString(R.string.AnsiblePremiumUserGiftedPremiumOutboundDialogSubtitle, user != null ? user.first_name : ""), accentColor == null ? getThemedColor(Theme.key_windowBackgroundWhiteBlueButton) : accentColor));
            } else if (user == null || TextUtils.isEmpty(user.first_name) || user.id == 777000) {
                titleView[0].setText(AndroidUtilities.replaceSingleLink(LocaleController.formatString(R.string.AnsiblePremiumUserGiftedPremiumDialogTitleWithPluralSomeone, LocaleController.formatPluralString("GiftMonths", giftTier.getMonths())), accentColor == null ? getThemedColor(Theme.key_windowBackgroundWhiteBlueButton) : accentColor));
                subtitleView.setText(AndroidUtilities.replaceTags(LocaleController.getString(R.string.AnsiblePremiumUserGiftedPremiumDialogSubtitle)));
            } else {
                titleView[0].setText(AndroidUtilities.replaceSingleLink(LocaleController.formatString(R.string.AnsiblePremiumUserGiftedPremiumDialogTitleWithPlural, user.first_name, LocaleController.formatPluralString("GiftMonths", giftTier.getMonths())), accentColor == null ? getThemedColor(Theme.key_windowBackgroundWhiteBlueButton) : accentColor));
                subtitleView.setText(AndroidUtilities.replaceTags(LocaleController.getString(R.string.AnsiblePremiumUserGiftedPremiumDialogSubtitle)));
            }
        } else if (gift != null) {
            ...
            if (user == null) {
                titleView[0].setText(LocaleController.getString(R.string.AnsiblePremium));
                subtitleView.setText(AndroidUtilities.replaceTags(LocaleController.getString(R.string.AnsiblePremiumSubscribedSubtitle)));
            } else {
                titleView[0].setText(AndroidUtilities.replaceSingleLink(LocaleController.formatString(R.string.AnsiblePremiumUserDialogTitle, ContactsController.formatName(user.first_name, user.last_name)), accentColor == null ? getThemedColor(Theme.key_windowBackgroundWhiteBlueButton) : accentColor));
                subtitleView.setText(AndroidUtilities.replaceTags(LocaleController.getString(R.string.AnsiblePremiumUserDialogSubtitle)));
            }
        }
        try {
    ...
    protected CharSequence getTitle() {
        return LocaleController.getString(R.string.AnsiblePremium);
    }
