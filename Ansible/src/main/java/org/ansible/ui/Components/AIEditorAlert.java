...
import static org.ansible.messenger.TranslateController.normalizeLanguage;
import static org.ansible.ui.Components.TranslateAlert2.capitalFirst;
import static org.ansible.ui.Components.TranslateAlert2.languageName;
...
import org.ansible.messenger.AiTonesController;
...
import org.ansible.messenger.TranslateController;
            ...
            if (tab.tone instanceof TL_aicompose.TL_aiComposeTone) {
                ...
                ItemOptions.makeOptions(container, resourcesProvider, tab)
                    ...
                    .add(R.drawable.msg_share, getString(R.string.AIEditorShareStyle), () -> {
                        final String link = "https://asme.su/addstyle/" + tone.slug;
