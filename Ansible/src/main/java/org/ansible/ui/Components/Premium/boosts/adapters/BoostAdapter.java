package org.ansible.ui.Components.Premium.boosts.adapters;
...
import org.ansible.ui.Components.Premium.boosts.cells.AddChannelCell;
import org.ansible.ui.Components.Premium.boosts.cells.BoostTypeCell;
import org.ansible.ui.Components.Premium.boosts.cells.BoostTypeSingleCell;
import org.ansible.ui.Components.Premium.boosts.cells.ChatCell;
import org.ansible.ui.Components.Premium.boosts.cells.DateEndCell;
import org.ansible.ui.Components.Premium.boosts.cells.EnterPrizeCell;
import org.ansible.ui.Components.Premium.boosts.cells.HeaderCell;
...
//    }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            ...
            case HOLDER_TYPE_SUBTITLE:
                view = new org.ansible.ui.Cells.HeaderCell(context, Theme.key_windowBackgroundWhiteBlueHeader, 21, 15, 3, false, resourcesProvider);
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        switch (viewType) {
            ...
            case HOLDER_TYPE_SUBTITLE: {
                org.ansible.ui.Cells.HeaderCell cell = (org.ansible.ui.Cells.HeaderCell) holder.itemView;
                cell.setText(item.text);
                break;
            }
            case HOLDER_TYPE_TEXT_DIVIDER: {
