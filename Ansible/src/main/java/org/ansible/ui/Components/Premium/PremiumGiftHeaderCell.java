...
public class PremiumGiftHeaderCell extends LinearLayout {
    ...
    public void bind(TLRPC.User user) {
        ...
        titleView.setText(AndroidUtilities.replaceTags(LocaleController.getString(R.string.GiftAnsiblePremiumTitle)));
        subtitleView.setText(AndroidUtilities.replaceTags(LocaleController.formatString(R.string.GiftAnsiblePremiumDescription, user.first_name)));
    }
}
