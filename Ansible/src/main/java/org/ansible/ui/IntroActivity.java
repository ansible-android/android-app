...
import org.ansible.messenger.Intro;
...
import org.ansible.ui.Components.BottomPagesView;
...
public class IntroActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    public View createView(Context context) {
        logoDrawable = context.getResources().getDrawable(R.drawable.ansible_logo).mutate();
