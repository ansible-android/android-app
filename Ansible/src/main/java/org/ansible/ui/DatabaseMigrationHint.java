...
public class DatabaseMigrationHint extends FrameLayout {
    ...
    public DatabaseMigrationHint(Context context, int currentAccount) {
        ...
        title.setText(LocaleController.getString(R.string.OptimizingAnsible));
        ...
        description1.setText(LocaleController.getString(R.string.OptimizingAnsibleDescription1));
        ...
        description2.setText(LocaleController.getString(R.string.OptimizingAnsibleDescription2));
