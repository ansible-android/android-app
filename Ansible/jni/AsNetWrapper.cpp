...
static const char *NativeByteBufferClassPathName = "org/ansible/asnet/NativeByteBuffer";
...
static const char *ConnectionsManagerClassPathName = "org/ansible/asnet/ConnectionsManager";
static JNINativeMethod ConnectionsManagerMethods[] = {
        ...
        {"native_checkProxy", "(ILjava/lang/String;ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;Lorg/ansible/asnet/RequestTimeDelegate;)J", (void *) checkProxy},
...
Java_org_ansible_asnet_ConnectionsManager_native_1test_1AuthAuthorization(JNIEnv *env, jclass clazz, jlong address) {
...
extern "C" int registerNativeAsNetFunctions(JavaVM *vm, JNIEnv *env) {
    java = vm;
    ...
    jclass_RequestTimeDelegate = (jclass) env->NewGlobalRef(env->FindClass("org/ansible/asnet/RequestTimeDelegate"));
    ...
    jclass_ConnectionsManager = (jclass) env->NewGlobalRef(env->FindClass("org/ansible/asnet/ConnectionsManager"));
