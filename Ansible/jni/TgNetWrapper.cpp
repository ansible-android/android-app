...
static const char *NativeByteBufferClassPathName = "org/ansible/tgnet/NativeByteBuffer";
...
static const char *ConnectionsManagerClassPathName = "org/ansible/tgnet/ConnectionsManager";
static JNINativeMethod ConnectionsManagerMethods[] = {
        ...
        {"native_checkProxy", "(ILjava/lang/String;ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;Lorg/ansible/tgnet/RequestTimeDelegate;)J", (void *) checkProxy},
...
Java_org_ansible_tgnet_ConnectionsManager_native_1test_1AuthAuthorization(JNIEnv *env, jclass clazz, jlong address) {
...
extern "C" int registerNativeTgNetFunctions(JavaVM *vm, JNIEnv *env) {
    ...
    jclass_RequestTimeDelegate = (jclass) env->NewGlobalRef(env->FindClass("org/ansible/tgnet/RequestTimeDelegate"));
    ...
    jclass_ConnectionsManager = (jclass) env->NewGlobalRef(env->FindClass("org/ansible/tgnet/ConnectionsManager"));
